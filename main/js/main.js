...
//        设置当前小圆点点亮
    ...
    //我们的优势
    $('.advantages .advantages-box .advantages-box1').css({
        width:0,
        height:0,
        display:'none'
...
$('.advantages').on('mouseenter', function () {
    $('.advantages .advantages-box .advantages-box1').css({ display:'block'})
    $('.advantages .advantages-box .advantages-box1').animate({ width:'260px',
        height:'180px'},800,function(){
        $('.advantages').off()
    })
    ...
    $('.success-case .container li').css({height:'0px',width:'20px'})
    $('.success-case').on('mouseenter', function () {
        $('.success-case .container li').animate({height:'256px',width:'20px'},400, function () {
            $('.success-case .container li').animate({width:'360px'},400, function () {
                    $('.success-case').off();
            })
        })
    })
